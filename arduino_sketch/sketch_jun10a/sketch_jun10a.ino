#define FW_VERSION "FW 09.06.2019"
...
//-----------------------------------------------------------------------------  
//                 WEB-СЕРВЕР. СТРАНИЦА СОСТОЯНИЯ ТЕПЛИЦЫ
//-----------------------------------------------------------------------------
void handleRoot(){
  String str = "";
  str += F("<!DOCTYPE HTML>");
  ...
  str += F("<title>WiFi BigGreenHouse</title>");
  ...
  if(digitalRead(valve)) {
    irrig_cont = now() - start_irrig; // прошло времени после начала  полива
    str += F("ctrl_on\" value=\" ОТКРЫТ");
    str += F("\"></p>");
    str += F("<p>От начала полива прошло : </p><p>");
    str += F("<p><font class=\"ctrl\">");
  ...
  if(!digitalRead(valve)) {
    ...
    str += F("ctrl_off\" value=\" ЗАКРЫТ");
    str += F("\"></p>");
    str += F("<p>После окончания предыдущего полива прошло:</p>");
    str += F("<p><font class=\"ctrl\" >");
  ...
  str += F("<p><font class=\"ctrl_txt\"> WiFi </font>");
  ...
  str += F("<p><font class=\"ctrl_txt\">SSID : </font>");
  str += F("<input type=\"SUBMIT\" class=\"ctrl\" value=\"");
  str += String(ssid);
  str += F("\"></p>");
  str += F("</form>");
  if(WiFi.status() == WL_CONNECTED) {
    str += F("<p><font class=\"ctrl_txt\"> IP addres: </font>");
    str += F("<font class=\"ctrl\">"); 
    str += WiFi.localIP().toString();
    str += F("</font></p>");
    str += F("<p><font class=\"ctrl_txt\"> MQTT </font>");
    if(client.connect("BigGreenHouse")) str += F("<font color = \"#009900\"> CONNECTED !</font></p>");
    else str += F("<font color = \"#FF0000\"> NOT CONNECTED !!!</font></p>");
    str += F("<form method=\"GET\" action=\"/mqtt_update\">");
    str += F("<p><font class=\"ctrl_txt\"> broker : </font>");
    str += F("<input type=\"SUBMIT\" class=\"ctrl\" value=\"");
...
//-----------------------------------------------------------------------------  
//                 WEB-СЕРВЕР. СТРАНИЦА УСТАНОВКИ ДАТЫ И ВРЕМЕНИ
//-----------------------------------------------------------------------------
void date_time(){
String str = "";
  str += F("<!DOCTYPE HTML>");
  ...
  str += F("<head>");
  str += F("<meta charset=\"UTF-8\" name=\"viewport\" content=\"width=device-width, initial-scale=1\">");
  str += F("<title>Date Time BigGreenHouse</title>");
  str += F("<style type=\"text/css\">");
  str += F("body {"); 
  str += F(" background-color: #FFFFFF;"); 
  str += F(" font-family: Arial, Helvetica, Sans-Serif;"); 
  ...
  str += F("<p><font class=\"txt\"><u> Дата и Время </u></font></p>");
  ...
  str += F("<p><input type=\"SUBMIT\" class=\"btn\" value=\"Вернуться на Главный экран\"></p>");
  str += F("</form>");         
  str += F("</body>");
  str += F("</html>\n\r");
  delay(100);          
...
//-----------------------------------------------------------------------------  
//                 WEB-СЕРВЕР. СТРАНИЦА ВЫБОРА РЕЖИМА УПРАВЛЕНИЯ
//-----------------------------------------------------------------------------
void ctrl_mode(){
  String str = "";
  str += F("<!DOCTYPE HTML>");
  ...
  str += F("<head>");
  str += F("<meta charset=\"UTF-8\" name=\"viewport\" content=\"width=device-width, initial-scale=1\">");
  str += F("<title>Control mode BigGreenHouse</title>");
  str += F("<style type=\"text/css\">");
  str += F("body {"); 
  str += F(" background-color: #FFFFFF;"); 
  str += F(" font-family: Arial, Helvetica, Sans-Serif;"); 
  ...
  str += F("</head>");
  str += F("<body>");
  str += F("<form method=\"POST\" action=\"/ctrl_mode_set\">");
  str += F("<p><font class=\"txt\"><u>РЕЖИМ УПРАВЛЕНИЯ </u></font></p>");
  str += F("<p><input type=\"radio\" style=\"width: 40px; \" name=\"ctrl\" value=\"false\" "); 
  if(!ctrl) str += F("checked/> <font color = \"#0000FF\"; ><u>Локальный</u></font>");
  else  str += F("/> Локальный");
  str += F("</p>");
  str += F("<p><input type=\"radio\" style=\"width: 40px; \" name=\"ctrl\" value=\"true\" ");
  if(ctrl)str += F("checked/> <font color = \"#00a000\"; ><u>Дистанционный</u></font>");
  else str += F("/> Дистанционный");
  str += F("</p><br />");
  str += F("<p><input type=\"SUBMIT\" class = \"btn\" value=\"Установить режим\" /></p>");
  str += F("</form>");
  str += F("<form method=\"GET\" action=\"/\">");
  str += F("<p><input type=\"submit\" value=\"Вернуться на Главный экран\"></p>");
  str += F("</form>");         
  str += F("</body>");
  str += F("</html>\n\r");
  delay(100);          
...
//-----------------------------------------------------------------------------  
//             WEB-СЕРВЕР. СТРАНИЦА НАСТРОЙКИ УПРАВЛЕНИЯ ВЕНТИЛЯЦИЕЙ
//-----------------------------------------------------------------------------
void ventilation_adj(){
  ...
  str += F("<head>");
  str += F("<meta charset=\"UTF-8\" name=\"viewport\" content=\"width=device-width, initial-scale=1\">");
  str += F("<title>НАСТРОЙКА УПРАВЛЕНИЯ ВЕНТИЛЯЦИЕЙ</title>");
  str += F("<style type=\"text/css\">");
  ...
  str += F("</head>");
  str += F("<body>");
  str += F("<form  method=\"POST\" action=\"/ventilation_adj_set\">");
  str += F("<u> УСТАВКИ ДАТЧИКА ТЕМПЕРАТУРЫ И ВЛАЖНОСТИ ВОЗДУХА</u><br />");
  ...
  str +=F("\n\"/> +/- 5.0 % </p>");
  str += F("<input type=\"submit\" value=\"Применить уставки\" />");
  str += F("</form><br />");
  str += F("<form method=\"GET\" action=\"/\">");
...
void ventilation_adj_set(){
  ...
  str += F("<html>");
  str += F("<head>");
  str += F("<meta http-equiv=\"refresh\" content=\"1; http:/ventilation_adj\">");
  str += F("</head>");
  str += F("</html>\n\r");
  delay(100);          
  server.send ( 200, "text/html", str );            
...
//-----------------------------------------------------------------------------  
//             WEB-СЕРВЕР. СТРАНИЦА НАСТРОЙКИ УПРАВЛЕНИЯ ПОЛИВОМ
//-----------------------------------------------------------------------------
void irrigation_adj(){
  String str = "";
  str += F("<!DOCTYPE HTML>");
  ...
  str += F("</head>");
  str += F("<body>");
  str += F("<form  method=\"POST\" action=\"/irrigation_adj\">");
  str += F("<u> УСТАВКИ ДАТЧИКА ВЛАЖНОСТИ ПОЧВЫ</u><br />");
...
void irrigation_adj_set(){
  ...
  str += F("<html>");
  str += F("<head>");
  str += F("<meta http-equiv=\"refresh\" content=\"1; http:/irrigation_adj\">");
  str += F("</head>");
  str += F("</html>\n\r");
  delay(100);          
  server.send ( 200, "text/html", str );            
...
//-----------------------------------------------------------------------------
  void http_server() {     
    ...
    server.on("/ventilation_adj_set", ventilation_adj_set);
    server.on("/irrigation_adj", irrigation_adj);
    server.on("/irrigation_adj_set", irrigation_adj_set);

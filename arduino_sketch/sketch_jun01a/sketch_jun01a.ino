...
void handleRoot(){
  ...
  str += F("<!DOCTYPE HTML>\
            ...
            <style type=\"text/css\">\
              body {background-color: #FFFFFF; font-family: Arial, Helvetica, Sans-Serif; Color: #000000; font-size: 12pt;}\
...
void handleSet(){
  ...
  str += F("<form method=\"POST\" action=\"/date_time\">\
            <br \>\
            Дата : \
            <input type=\"text\" style=\"width: 20px;\"  name=\"day\" value=\" ");
  str += String(day());
  str += F("\n\"/>.\
            <input type=\"text\" style=\"width: 20px;\" name=\"month\" value=\" ");
  str += String(month());
  str += F("\n\"/>.\
            <input type=\"text\" style=\"width: 40px;\" name=\"year\" value=\" ");
  str += String(year());
  str += F("\n\"/> г. &nbsp Время : \
            <input type=\"text\" style=\"width: 20px;\" name=\"hour\" value=\" ");
  str += String(hour());
  str += F("\n\"/>:\
            <input type=\"text\" style=\"width: 20px;\" name=\"minute\" value=\" ");
  str += digits_to_String(minute());
  str += F("\n\"/>:\
            <input type=\"text\" style=\"width: 20px;\" name=\"second\" value=\" ");
  str += digits_to_String(second());
  str += F("\n\"/><br /><br />\
            <input type=\"submit\" value=\"Установить Дату и Время\" />\
            </form><hr /><br />");
  ...
  str += F("<form  method=\"POST\" action=\"/adjustment\">\
            <u> УСТАВКИ ТЕМПЕРАТУРЫ И ВЛАЖНОСТИ </u><br />\
            <p>- температура воздуха ...\
            <input type=\"text\" style=\"width: 40px; \" name=\"set_temp\" value=\" "); 
  str += float_to_String(set_temp);
  str += F("\n\"/> +/- 1.0 град.С </p>\
            <p>- влажность воздуха .......\
            <input type=\"text\" style=\"width: 40px; \" name=\"set_hum\" value=\" ");
  str += float_to_String(set_hum);
  str +=F("\n\"/> +/- 5.0 % </p>\
            <p>- влажность почвы ..........\
            <input type=\"text\" style=\"width: 40px; \" name=\"set_moist\" value=\" ");
  str += float_to_String(set_moist);
  str += F("\n\"/> +/- 5.0  % </p>\
            <u>КАЛИБРОВКА ДАТЧИКА ВЛАЖНОСТИ ПОЧВЫ </u><br />\
            <p>&nbsp&nbsp выход датчика = &nbsp");
  str += analog_sensor;
  str += F(" &nbsp ед. </p>\
            <p>- значение для 0% ...\         
            <input type=\"text\" style=\"width: 40px; \" name=\"air_val\" value=\" ");
  str += air_val;
  str += F("\n\"/> &nbsp ед. </p>\
            <p>- значение для 100% ...\         
            <input type=\"text\" style=\"width: 40px; \" name=\"water_val\" value=\" ");
  str += water_val;
  str += F("\n\"/> &nbsp ед. </p><br />\  
  ...
  str += F("<hr /><input type=\"submit\" value=\"Изменить настройки WiFi и MQTT\" />\
            ...
            <input type=\"submit\" value=\"Вернуться на Главный экран\">\
            </form>\            
            </body>\
            </html>\n\r");
  delay(100);          

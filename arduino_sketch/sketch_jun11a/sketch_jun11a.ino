...
void ctrl_mode(){
  ...
  str += F("<p><font class=\"txt\">РЕЖИМ УПРАВЛЕНИЯ : </font></p>");
  ...
  str += F("</form>");
  str += F("<form method=\"GET\" action=\"/\">");
  str += F("<p><input type=\"submit\" value=\"НА ГЛАВНЫЙ ЭКРАН\"></p>");
  str += F("</form>");         
  str += F("</body>");
  str += F("</html>\n\r");
  delay(100);          
...
void ventilation_adj(){
  ...
  str += F("<p><font class=\"sensors_txt\"> температура </font>");
  str += F("<input type=\"TEXT\" class=\"sensors_val\"  name=\"set_temp\" value=\" "); 
  str += float_to_String(set_temp);
  str += F("\n\"/> +/- 1.0 град.С </p>");
  str += F("<p><font class=\"sensors_txt\"> влажность </font>");
  str += F("<input type=\"TEXT\" class=\"sensors_val\" name=\"set_hum\" value=\" ");
...
void ventilation_adj_set(){
  ...
  str += F("<html>");
  str += F("<head>");
  str += F("<meta http-equiv=\"refresh\" content=\"1; /ventilation_adj\">");
  str += F("</head>");
  str += F("</html>\n\r");
  delay(100);          
  server.send ( 200, "text/html", str );            
...
//-----------------------------------------------------------------------------
  void http_server() {     
    ...
    server.on("/ventilation_on", [](){ 
     String str =  F("<!DOCTYPE HTML>");
     str += F("<html>");
     str += F("<head>");
     str += F("<meta http-equiv=\"refresh\" content=\"1; ventilation_adj\">");
     str += F("</head>");
